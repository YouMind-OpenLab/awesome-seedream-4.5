...
- [🤔 ${t('whatIs', locale)}](#-what-is-seedream-45)
...
1. Click [**${t('submitNewPrompt', locale)}**](https://github.com/YouMind-OpenLab/awesome-seedream-4.5/issues/new?template=submit-prompt.yml)
2. ${t('fillForm', locale)}
